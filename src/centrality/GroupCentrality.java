...
public class GroupCentrality {
	...
	private NodeCentrality nodeCentralityComputer;
	...
	public NodeCentrality getNodeCentralityComputer(){
		return nodeCentralityComputer;
	}
	...
	public GroupCentrality(Graph<String, DefaultEdge> inputGraph, String sourceAddr, String destinationAddr, String groupAddr) throws IOException {
		...
		nodeCentralityComputer = new NodeCentrality(graph, sourceSet, destinationSet);
	}
	 ...
	 */
	public long getConditionalImpact(String theNode, Set<String> theGroup){
		if(theGroup.isEmpty()){
			return nodeCentralityComputer.getNodeImpact(theNode);
		}else{
